    ...
    public void Update()
    {
        ...
        for (int i = _audioLayers.Count - 1; i >= 0; i--)
        {
            ...
            if (layer.Time > layer.Duration)
            {
                ...
                // we need to assign a new clip from the pool assgined to this layer
                ...
                {
                    // The clip assigned to this layer has finished playing and is not set to lop 
            ...
            {
                // If this the highest layer then record that... its the clip currently playing
        ...
        // Remember the currently active layer for the enxt update check 
